...
<section class="slide stack adjacent-prior-art-slide" data-kind="appendix" data-note-key="paa1"><div class="slidehead"><div class="eyebrow">Appendix · adjacent systems</div><h2>Useful comparisons — but weaker main-deck candidates</h2></div><div class="cards3"><div class="panel"><h3>JetBrains MPS</h3><p>A comprehensive projectional workbench: structure, editor, type system, constraints, transformations and code generation. Use it for “why not a full workbench?” questions.</p></div><div class="panel"><h3>Spoofax / Rascal</h3><p>Textual language-engineering environments for syntax, static semantics, transformations, compilers and IDE services. Strong authoring/tooling comparators, weaker planner comparators.</p></div><div class="panel"><h3>Truffle / Graal</h3><p>Language implementation through self-optimizing AST interpreters and partial evaluation. Relevant to the performance/specialization story, not the primary composition story.</p></div></div><p class="caption centertext">Also keep Xtext / parser generators as baseline tooling, not as headline architectural competitors. Lua is useful as an embedding example, but too far from the central research question for the main matrix.</p><div class="sourcebar"><a href="https://www.jetbrains.com/help/mps/mps-faq.html" rel="noreferrer" target="_blank">MPS</a><a href="https://spoofax.dev/" rel="noreferrer" target="_blank">Spoofax</a><a href="https://www.rascal-mpl.org/docs/Rascalopedia/LanguageDefinition/" rel="noreferrer" target="_blank">Rascal</a><a href="https://www.graalvm.org/jdk22/graalvm-as-a-platform/language-implementation-framework/" rel="noreferrer" target="_blank">Truffle</a></div></section>
`);
